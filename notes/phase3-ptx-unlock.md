...
**entire layer configuration as template parameters**. Demangled with `c++filt`
(`notes/ptx-demangled.txt`, 304 symbols). The namespace is `tin3_1` — the
"tinlayout" of the kernel names.
